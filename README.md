![Profile Animation](https://capsule-render.vercel.app/api?type=waving&color=gradient&height=200&section=header&animation=twinkling&fontAlignY=35&text=Christian%20BAMOGO&descAlignY=55&desc=Researcher%20(HIT%20Lab)%20|%20Cyber-Physical%20Systems%20Safety%20|%20Intelligent%20Control%20|%20AI-driven%20Solutions&fontSize=60&fontColor=fff&descSize=16)
...
* 🔗 [NLP Legal Assist](https://github.com/ChrislyTech/NLP-LegalAssist) – NLP-based **legal document summarization** and **semantic search system** using transformer embeddings for contextual retrieval.  
* 🔗 [Bone Fracture Detection with Deep Learning – Stanford MURA Dataset](https://github.com/ChrislyTech/BoneFracture-Detection) – **CNN-based medical imaging project** for bone fracture detection and classification using the **Stanford MURA dataset**.  
...
| Domain | Skills |
| :--- | :--- |
| **Programming** | **Python**, MATLAB, C/C++, Flutter, Dart, Java, HTML/CSS |
